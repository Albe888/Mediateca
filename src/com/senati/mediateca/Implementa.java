...
public class Implementa {
	...
	public static void main(String[] args) {
        ...
        Cintavideo cl11 = new Cintavideo(3423544,"La divina comedia", 200, "Dante", "Dante",null ,20);
        Cintavideo cl22 = new Cintavideo(3423544,"La divina comedia", 200, "Dante", "Dante",null ,20);
        Cintavideo cl33 = new Cintavideo(3423544,"La divina comedia", 200, "Dante", "Dante",null ,20);
        Cintavideo cl44 = new Cintavideo(3423544,"La divina comedia", 200, "Dante", "Dante",null ,20);
        Cintavideo cl55 = new Cintavideo(3423544,"La divina comedia", 200, "Dante", "Dante",null ,20);
      ...
      ///cinta libro
        ...
        Libros li1 = new Libros(12213214,"la divina comedia", 20, "dante", 17, 12);
        Libros li2 = new Libros(14323434,"la divina comedia", 20, "dante", 17, 12);
        Libros li3 = new Libros(12213214,"la divina comedia", 20, "dante", 17, 12);
        Libros li4 = new Libros(13132124,"la divina comedia", 20, "dante", 17, 12);
        Libros li5 = new Libros(12232214,"la divina comedia", 20, "dante", 17, 12);
